  ...
  return (
    <>
        <nav className="bg-black-800 mb-20 flex items-center justify-between py-6">
            ...
            <a className="hover:text-blue-400 hover:scale-125 hover:drop-shadow-[0_0_20px_rgba(0,112,244,1)] transition-all duration-300" href="https://www.linkedin.com/in/y-sh/" target="_blank"><FaLinkedin /></a>
